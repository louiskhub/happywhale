...
from util import TARGET_SHAPE, TRAIN_DATA_PATH, TRAIN_INDIVIDUAL_DF


# highly inspired by kaggle notebook !
...
filepath = "../../extracted_foregrounds"

if filepath[6:] not in os.listdir("../../"):
    os.makedirs(filepath)

all = len(TRAIN_INDIVIDUAL_DF["image"])
for count, i in enumerate(TRAIN_INDIVIDUAL_DF["image"]):
    print(count, "/", all)
    img = extract_foreground(i)
